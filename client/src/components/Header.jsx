    ...
    return (
        <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
           ...
           border-primary/40 bg-primary/10 rounded-full text-sm'>
                ...
                <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:test-xs text-gray-500'>This is your place to think out loud
                    ,to share what matters,
                    and to write without filters.wheather it's one word
                    or a thousand,your story starts here.
            ...
            <img src={assets.gradientBackground} className='absolute -top-50 z-10 opacity-50 pointer-events-none' alt='' />
        </div>
    )
}
