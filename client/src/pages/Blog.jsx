...
const Blog = () => {
  ...
  const fetchBlogData = async () => {
   /* const data = blog_data.find(item => item._id === id) // dummy data
    setData(data)
     */
  ...
  return data ? (
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600'>
        ...
        <h2 className='my-5 max-w-lg truncate mx-auto'></h2>
        <p className='inline-block py-1 px-4 rounded-full mb-6 border text-sm
        border-primary/35 bg-primary/5 font-medium text-primary'>Stefan Salvatore</p>
      </div>
      ...
      <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6 '>
        ...
        <div className='mt-14 mb-10 max-w-3xl mx-auto'>
          <p className='font-semibold mb-4'>Commemts({comments.length})</p>
          <div className='flex flex-col gap-4'>
            {comments.map((item,index) => (
              ...
              max-w-xl p-4 rounded text-gray-600'>
                  ...
                  <div className='absolute right-4 bottom-3 flex items-center justify-centergap-2 text-xs'>
        ...
        <div className='max-w-3xl mx-auto'>
          ...
          border-gray-300 rounded outline-none'></input>
